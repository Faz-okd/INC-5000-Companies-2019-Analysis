# INC-5000-Companies-2019-Analysis
This project analyzes the 2019 Inc. 5000 list, an annual ranking of the fastest-growing private companies in the United States. Using a dataset of 5,000 organizations, I built a dynamic Power BI dashboard to uncover the drivers behind high-velocity business growth.
Key Insights & Questions Answered
I designed this dashboard to answer specific business questions:
...
### Key Skills:
Data Cleaning: Handling missing values and formatting currency/revenue strings in Power Query.
